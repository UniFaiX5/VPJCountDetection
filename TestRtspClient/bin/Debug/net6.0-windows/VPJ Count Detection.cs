...
namespace VPJCountDetection
{
...

    {
        ...
        string logo = (@"C:\Users\Admin\source\repos\RtspClientSharpCore\TestRtspClient\lib\pngwing.png");
        ...
        public void InvokeButtonvisibilityOC()
        {
            if (InvokeRequired)
            {
                this.Invoke(new Action(InvokeButtonvisibilityOC), new object[] { });
                return;
            }
            buttonrun.Visible = true;
            buttonStop.Visible = false;
        ...
        public void InvokeButtonvisibilityFC2()
        {
            if (InvokeRequired)
            {
                this.Invoke(new Action(InvokeButtonvisibilityFC2), new object[] { });
                return;
            }
        ...
        public void InvokeButtonvisibilityFC()
        {
            if (InvokeRequired)
            {
                this.Invoke(new Action(InvokeButtonvisibilityFC), new object[] { });
                return;
            }
            buttonrun.Visible = false;
            buttonStop.Visible = false;
...

        {
            ...
            if (FGcode == 32 || FGcode == 67 || FGcode == 67 || FGcode == 67 || FGcode == 68)
            {
                //TEST jar
                Bountlecount = 12;
                AddStatus("TEST FGcode loeaded for 50ml Jar & boundle count is 2", "Information");
                Format = "TEST 50ml Jar & boundle count is 12";

            }


            if (FGcode == 32713097 || FGcode == 67830744 || FGcode == 67931458 || FGcode == 67931464 || FGcode == 68766929 || FGcode == 68936940 )
            {
                //50ml jar
                Bountlecount = 12;
            ...
            if (FGcode == 32713100 || FGcode == 32713096 || FGcode == 67931456 || FGcode == 67931467 || FGcode == 68397455 || FGcode == 68766927 || FGcode == 67931462)
            {
                // 100ml jar
                Bountlecount = 12;
            ...
            if (FGcode == 32713099 || FGcode == 32713095 || FGcode == 67931457 || FGcode == 67931465 || FGcode == 67931466 || FGcode == 68397457 || FGcode == 68650979 || FGcode == 68650977 || FGcode == 68766928 || FGcode == 67931461)
            {
                //250ml
                Bountlecount = 6;
            ...
            if (FGcode == 32713094 || FGcode == 32713093 || FGcode == 68117290 || FGcode == 67931459 || FGcode == 67931460 || FGcode == 67931463 || FGcode == 68517025 || FGcode == 68650971 || FGcode == 68650973 || FGcode == 68650969 || FGcode == 68766930 || FGcode == 32713098 || FGcode ==67931463)
            {
                //450ml
                Bountlecount = 6;
            ...
            if (FGcode == 68936940 || FGcode == 67931462 || FGcode == 67931461 || FGcode == 32713097 || FGcode == 32 || FGcode == 67 || FGcode == 67830744 || FGcode == 67931458 || FGcode == 67931464 || FGcode == 68766929 || FGcode == 32713100 || FGcode == 32713096 || FGcode == 67931456 || FGcode == 67931467 || FGcode == 68397455 || FGcode == 68766927 || FGcode == 32713099 || FGcode == 32713095 || FGcode == 67931457 || FGcode == 67931465 || FGcode == 67931466 || FGcode == 68397457 || FGcode == 68650979 || FGcode == 68650977 || FGcode == 68766928 || FGcode == 32713094 || FGcode == 32713093 || FGcode == 68117290 || FGcode == 67931459 || FGcode == 67931460 || FGcode == 67931463 || FGcode == 68517025 || FGcode == 68650971 || FGcode == 68650973 || FGcode == 68650969 || FGcode == 68766930 || FGcode == 32713098)
            { 
            
            }
            else
            {
                AddStatus("FGCode unidentified / not in Hardcoded FG list " + FGcode, "Error");
                        ...
                        if (looper = true)
                        {
                            ...
                            if (result.Prediction == "good")
                            {
                                ...
                                else
                                {
                                    ...
                                    Engine.testImage.Save(Path.Combine(@"C:\ImageMLProjects\BadSampleHistory\", fileName), ImageFormat.Jpeg);
        ...
        public  async Task SaveOnePicture(ConnectionParameters connectionParameters)
        {
            ...
            smpimg?.Save(Path.Combine(@"C:\ImageMLProjects\RTSPTrials\RTSPClientNetCore", "image.jpg"), ImageFormat.Jpeg);
