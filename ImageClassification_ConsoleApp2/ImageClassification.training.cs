    ...
    public partial class ImageClassification
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.LoadImages(outputColumnName:@"input1",imageFolder:@"",inputColumnName:@"ImageSource")      
                                    ...
                                    .Append(mlContext.Transforms.ApplyOnnxModel(modelFile:@"C:\Users\Admin\source\repos\RtspClientSharpCore\ImageClassification_ConsoleApp1\ImageClassification.onnx"));
